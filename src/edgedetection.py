...
class EdgeDetection:
    def gradient(self, img, orientation, sobel_kernel, threshold, l_channel):
        if orientation == 'x':
    ...
    def magnitude(self, img, sobel_kernel, threshold, l_channel):
    ...
    def direction(self, img, sobel_kernel, threshold, l_channel):
